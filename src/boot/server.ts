...
const server = "https://api.maraka.co.ls/buyandsellDjango-apis";
const bannersUrl = "/banners";
const productsUrl = "/product";
const timeUrl = '/server-time'
const productCreate = '/product-create';
const viewerUrl = "/product-viewer"
const carCreate = '/car';
export { server, bannersUrl, productsUrl, viewerUrl, productCreate, carCreate, timeUrl };